...
const TrackInfo = ({ text, currentTime, duration }: { text: string, currentTime: number, duration: number }) => {
    ...
    return (
        <div className="flex items-center justify-center gap-0 flex-1 min-w-0 px-1 md:px-2">
